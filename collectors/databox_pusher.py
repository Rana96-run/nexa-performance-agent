        ...
        return f"""
            ...
            camp AS (
              SELECT date, channel,
                     ...
                     ROUND(SAFE_DIVIDE(SUM(leads_disqualified), NULLIF(SUM(leads_qualified)+SUM(leads_disqualified), 0)) * 100, 2) AS disq_rate_pct,
                     ...
                     ROUND(SUM(all_revenue_won), 2) AS all_revenue_won,
        ...
        return f"""
            ...
            kw AS (
              SELECT date, channel,
                     ...
                     new_biz_roas,
                     all_deals_won,
                     ROUND(all_revenue_won, 2) AS all_revenue_won
    ...
    for r in rows:
        ...
        if grain == "campaign":
            rec = _row(base,
                ...
                leads_total       = _v(r.leads_total),
                leads_qualified   = _v(r.leads_qualified),
                leads_disqualified= _v(r.leads_disqualified),
                disq_rate_pct     = _v(r.disq_rate_pct),
                new_biz_deals_won = _v(r.new_biz_deals_won),
                new_biz_revenue_won= _v(r.new_biz_revenue_won),
                new_biz_roas      = _v(r.new_biz_roas),
                all_deals_won     = _v(r.all_deals_won),
                all_revenue_won   = _v(r.all_revenue_won),
                roas              = _v(r.roas),
            )
