"""
collectors/channel_inference.py
================================
...
Used by the HubSpot leads + deals collectors at write time.

Moved here from analysers/channel_inference.py (2026-06-17) when the
analysers/ layer was deleted (n8n replaced that orchestration layer).
