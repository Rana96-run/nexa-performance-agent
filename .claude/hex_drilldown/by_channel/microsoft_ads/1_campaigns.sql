-- ─────────────────────────────────────────────────────────────────────────────
-- HEX CELL — Campaigns drill-down (Microsoft Ads)
-- Variables consumed: start_date, end_date, channel_filter (optional)
-- Row-click output:   selected_campaign  (column: campaign_name)
--
-- Source: wide_ads (ad-grain base table — GROUP BY campaign_id rolls up to
-- campaign grain). spend, leads, and deal metrics all live here.
